...
class DCGAN(object):
  ...
  def build_model(self):
    ...
    self.volfrac_loss = tf.abs(tf.subtract(tf.multiply(20.0,tf.reduce_mean(tf.multiply(1/2,tf.add(self.G,1)))),0.85))
                          
    self.d_loss = self.d_loss_real + self.d_loss_fake + self.volfrac_loss
